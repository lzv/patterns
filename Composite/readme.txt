...
Проверку, может ли конкретный объект содержать данный объект, приходится проводить во времени выполнения. Например, очевидно, что строка не может содержать страницу, но без проверок такое возможно. Для этого, как вариант, можно ввести статическую переменную класса - уровень иерархии, переопределяемую при наследовании, и проверять при добавлении, что уровень дочернего объекта меньше текущего.

Есть два варианта реализации в виду различия листьев и остальных объектов. Можно сразу в абстрактном классе-интерфейсе реализовать методы для работы с дочерними объектами, но тогда необходимо отслеживать работу с листьями. Например, в статической переменной класса указывать, лист это или нет, и затем проверять ее. Либо можно реализовать эти методы для листьев, как ничего не делающие, и сделать специальный родительский класс для составных объектов, в которых и реализовать полностью эти методы. 
